...
//onclick topicname(domain) to search in quiz result page #viyash
function showresultanswersbytitle(title){

  var key=title.replace(/ /g,"_");
...
$(document).ready(function(){
    ...
    $('#formcreate_ticket').submit(function () {
        ...
        $(this).hide();
        //show message
        $('.new-ticket-form .modal-body .success-msg').show();

        //hide popup after n sec
        setTimeout(function(){
            $('.new-ticket-form').modal('toggle');
            return true;
        }, 3000);
